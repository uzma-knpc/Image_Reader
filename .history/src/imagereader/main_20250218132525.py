...
class uzma_ilyas:
    ...
    def save_image_from_url(self, image_url, image_name):
        """
...
# Function to load an image and convert it to grayscale
    ...
    model_gen = genai.GenerativeModel("gemini-1.5-flash")  # Or use os.getenv("MODEL", "gemini-1.5-pro")
...
def read():
    ...
    #obj.create_image_embedding()
    #obj.save_image_from_url()
    #obj.process_and_generate_reports()
    #obj.generate_report()
    #obj.read()