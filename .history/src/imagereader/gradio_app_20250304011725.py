    ...
    with gr.Blocks(title="MEDICAL IMAGE ANALYSIS SYSTEM") as iface:
        gr.Markdown("""
            <div style='text-align: center'>
                <h1 style='font-size: 2.5em; font-weight: bold; color: blue'>AI Driven MEDICAL IMAGE ANALYSIS SYSTEM (MEDISCAN-AI)</h1>
                <h2 style='font-size: 1.5em; font-weight: bold; color: green'>ATOMIC ENERGY CANCER HOSPITAL (AECHs)</h2>
                <p style='font-size: 1em; color: gray'>AI-Powered  Nuclear Medicine Analysis</p>
            </div>
        """)
