    ...
    with gr.Blocks(title="MEDICAL IMAGE ANALYSIS SYSTEM") as iface:
        gr.Markdown("""
            <div style='text-align: center'>
                <h1 style='font-size: 1.5em; font-weight: bold; color: blue'>AI Driven MEDICAL IMAGE ANALYSIS SYSTEM (MEDISCAN-AI)</h1>
                <h2 style='font-size: 1.0em; font-weight: bold; color: green'>ATOMIC ENERGY CANCER HOSPITAL (AECHs)</h2>
                <p style='font-size: 0.75em; color: black'>AI-Powered Medical Scan Interpreter</p>
            </div>
        """)
