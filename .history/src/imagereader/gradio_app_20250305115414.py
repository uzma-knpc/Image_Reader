...
def process_image(image, doctor_name):
    ...
    try:
        ...
        name_patient = patient_details.get('name', 'Not provided')
        id_patient = patient_details.get('id', 'Not provided')
...
👤 PATIENT DETAILS
----------------
• Name: {patient_details.get('Patient Name', name_patient)}
• Patient ID: {patient_details.get('Patient Id', id_patient)}
• Age/Gender: {patient_details.get('age_gender', 'Not provided')}
• Study: {patient_details.get('study_name', scan_type)}
• Pediatric State: {patient_details.get('pediatric_state', 'Not provided')}
• Modality: {patient_details.get('Manufacturer_Model', 'Not provided')}
